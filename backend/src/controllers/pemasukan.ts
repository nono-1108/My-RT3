...
export const createPemasukan = async (req: Request, res: Response) => {
  try {
    const data = req.body;
...
export const updatePemasukan = async (req: Request, res: Response) => {
  try {
...
export const deletePemasukan = async (req: Request, res: Response) => {
  try {
    const id = req.params.id as string;
