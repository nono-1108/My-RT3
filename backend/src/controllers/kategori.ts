...
// Kategori Pemasukan
export const getKategoriPemasukan = async (req: Request, res: Response) => {
  try {
...
export const createKategoriPemasukan = async (req: Request, res: Response) => {
  try {
...
export const updateKategoriPemasukan = async (req: Request, res: Response) => {
  try {
...
export const deleteKategoriPemasukan = async (req: Request, res: Response) => {
  try {
    const id = req.params.id as string;
...
export const updateKategoriPengeluaran = async (req: Request, res: Response) => {
  try {
    const id = req.params.id as string;
    const { nama, deskripsi } = req.body;
...
export const deleteKategoriPengeluaran = async (req: Request, res: Response) => {
  try {
    const id = req.params.id as string;
